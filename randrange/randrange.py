...
def main():
    ...
    argp.add_argument("low", type=int, help=(
        "the lower boundary for the allowable range"))
    argp.add_argument("high", type=int, help=(
        "the upper boundary for the allowable range"))
    argp.add_argument("-c", "--count", type=int, default=1, help=(
